              ...
              properties: {
                user: {
                  ...
                  properties: {
                    ...
                    termsAcceptedAt: { type: "string", nullable: true },
                    privacyAcceptedAt: { type: "string", nullable: true },
                    requiresTermsAcceptance: { type: "boolean" },
                    requiresPrivacyAcceptance: { type: "boolean" },
                  }
                },
      ...
      schema: {
        ...
        body: {
          ...
          properties: {
            ...
            phone: { type: "string", description: "Phone number in international format (e.g. +254712345678)" },
          },
        },
      },
      preHandler: [requireAuth],
