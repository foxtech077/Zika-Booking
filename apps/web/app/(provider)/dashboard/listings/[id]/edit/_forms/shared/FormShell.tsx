...
export function FormShell({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start w-full px-4 lg:px-8 max-w-[1600px] mx-auto">
      {/* Sticky stepper – 20‑22% width on desktop */}
      <aside
        className="lg:col-span-3 space-y-4 sticky top-[100px] h-[calc(100vh-140px)] overflow-y-auto pr-2 custom-scrollbar shadow-md"
        aria-label="Progress and steps"
      >
        {/* Progress card */}
        <Card
          padding="md"
          className="bg-[#F8F8F5] border border-[#556B2F]/20 text-[#3E4E22] shadow-sm relative overflow-hidden shrink-0"
        >
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-[10px] text-slate-400 mt-0.5 leading-normal break-words">
                    {step.sublabel}
                  </p>
                </div>
