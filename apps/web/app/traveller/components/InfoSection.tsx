      ...
      {listing.category === "car" && (
        <div className="pb-6 border-b border-slate-200 grid grid-cols-2 sm:grid-cols-3 gap-4 text-sm">
          ...
          {listing.driverProvided && (
            <div><span className="text-slate-400 block text-[10px] uppercase font-bold">Driver</span>Included</div>
          )}
          {!listing.driverProvided && listing.securityDeposit != null && listing.securityDeposit > 0 && (
