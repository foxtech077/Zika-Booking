            ...
            {loadingDetail ? (
              ...
              <>
                ...
                <div className="lg:col-span-12">
                  <PhotoGallery
                    primaryPhotoUrl={detailListing.primaryPhotoUrl}
                          ...
                          return (
                            <div className="space-y-4">
                              ...
                              <div className="flex gap-3 p-3 bg-slate-50 rounded-xl border border-slate-200">
                                {imgUrl(detailListing.primaryPhotoUrl) && (
                                  <img src={imgUrl(detailListing.primaryPhotoUrl)} alt={detailListing.name}
                                    className="w-16 h-16 rounded-lg object-cover shrink-0" onError={(e) => { (e.target as HTMLImageElement).style.display = "none"; }} />
                                )}
                                <div className="min-w-0">
          ...
          <div>
                            ...
                            {quickResults.map((listing) => (
                              ...
                              >
                                <div className="w-12 h-12 bg-slate-200 rounded-xl overflow-hidden shrink-0">
                                  {imgUrl(listing.primaryPhotoUrl) ? (
                                    <img
                                      src={imgUrl(listing.primaryPhotoUrl)}
                                      alt={listing.name}
                  ...
                  {recentlyViewed.map((item) => (
                    ...
                    >
                      <div className="w-16 h-16 bg-slate-100 rounded-xl overflow-hidden shrink-0">
                        <img
                          src={imgUrl(item.primaryPhotoUrl) ?? "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=200&q=60"}
                          alt={item.name}
                          className="w-full h-full object-cover group-hover:scale-105 transition duration-300"
                          onError={(e) => { e.currentTarget.src = "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=200&q=60"; }}
                        />
                      </div>
                      <div className="min-w-0">
            ...
            <section className="bg-[#0B1E3F] py-16">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
                <p className="text-xs font-bold text-blue-300 uppercase tracking-widest mb-2">Why Zika Booking</p>
            ...
            <footer className="bg-slate-900 text-slate-400 py-12">
              <div className="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                <div className="border-t border-slate-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                  <p className="text-xs">© {new Date().getFullYear()} Zika Booking. All rights reserved.</p>
